...
% functions with ode45().
    ...
    cineq = [max(-(7.718-abs(52.360*u_1(1:ind_1(1))+89.2857*(u_1(1:ind_1(1)).^2))))]; 
    %enforce power requirement
    %pi/2-min(acos(((p(2)/p(1))*cos(z_1(2,:)))))
    ceq = [ctrl.tf-t_1(ind_1(1))]; %enforce time and apex criteria
